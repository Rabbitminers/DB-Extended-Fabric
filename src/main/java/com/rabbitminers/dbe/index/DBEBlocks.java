...
import com.rabbitminers.dbe.blocks.RubberDuckBlock;
...
public class DBEBlocks {
    ...
    public static final Block BALLAST = registerBlock("ballast",
            new FacingBlock(FabricBlockSettings.of(Material.STONE).strength(1.0f, 6f)),DBEItemGroup.DBEGROUP);

    public static final Block BALLAST_SLAB = registerBlock("ballast_slab",
            new SlabBlock(FabricBlockSettings.of(Material.STONE).strength(1.0f, 6f)),DBEItemGroup.DBEGROUP);

    public static final Block GRAVEL_SLAB = registerBlock("gravel_slab",
            new SlabBlock(FabricBlockSettings.of(Material.SOIL).strength(1.0f, 6f)),DBEItemGroup.DBEGROUP);
    ...
    public static final Block HALF_LUMBER_BORDER = registerBlock("half_lumber_border",
            new FacingBlock(FabricBlockSettings.of(Material.STONE).strength(2.0f, 2.0f)),DBEItemGroup.DBEGROUP);
    ...
    public static final Block FULL_LOG_PILE = registerBlock("full_log_pile",
            new PillarBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f, 6f)),DBEItemGroup.DBEGROUP);
    public static final Block LOG_PALISADE = registerBlock("log_palisade",
            new PalisadeBlock(FabricBlockSettings.of(Material.WOOD).strength(1.0f, 6f).nonOpaque()),DBEItemGroup.DBEGROUP);
    public static final Block LOG_PILE_TOP = registerBlock("log_pile_1_top",
            new UpperSlab(FabricBlockSettings.of(Material.WOOD).strength(1.0f, 6f).nonOpaque()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block LOG_PILE_BOTTOM = registerBlock("log_pile_1_bottom",
            new BottomSlab(FabricBlockSettings.of(Material.WOOD).strength(1.0f, 6f).nonOpaque()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block TUNGSTEN_BLOCK = registerBlock("tungsten_carbite",
            new Block(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()), DBEItemGroup.DBEGROUP);
    ...
    public static final Block STEEL_PILLAR = registerBlock("steel_pillar",
            new PillarBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block STEEL_STAIRS = registerBlock("steel_stairs",
            new DBEStairs(DBEBlocks.CUT_STEEL.getDefaultState(), FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block STEEL_SLAB = registerBlock("steel_slab",
            new SlabBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    public static final Block STEEL_FRAME = registerBlock("steel_frame",
            new Block(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).nonOpaque().requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block STEEL_WALL = registerBlock("steel_wall",
            new WallBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block STEEL_DOOR = registerBlock("steel_door",
            new DoorBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block STEEL_TRAPDOOR = registerBlock("steel_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block STEEL_MESH_TRAPDOOR = registerBlock("steel_mesh_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).requiresTool().nonOpaque()),DBEItemGroup.DBEGROUP);

    public static final Block VENT_STRAIGHT = registerBlock("vent_straight",
            new FacingBlock(FabricBlockSettings.of(Material.METAL).strength(5.0f, 6f).nonOpaque().requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block STRIPED_BLOCK = registerBlock("stripedblock",
            new FacingBlock(FabricBlockSettings.of(Material.METAL).strength(1.5f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block PILLAR_BLOCK = registerBlock("copper_coil",
            new PillarBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block COMPUTER = registerBlock("pc_setup",
            new FacingBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).nonOpaque().requiresTool()),DBEItemGroup.DBEGROUP);

    public static final Block SERVER_RACK = registerBlock("server_rack",
            new FacingBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block LABORATORY_BLOCK = registerBlock("laboratory_block",
            new FacingBlock(FabricBlockSettings.of(Material.METAL).strength(2.1f, 6f).requiresTool()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block TRACK_END = registerBlock("track_end",
            new TrackEndBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool().nonOpaque()),DBEItemGroup.DBEGROUP);

    public static final Block BOOKS_1 = registerBlock("book_1",
            new TrackEndBlock(FabricBlockSettings.of(Material.WOOL).strength(0.8f, 0.8f).nonOpaque()),DBEItemGroup.DBEGROUP);

    public static final Block BOOKS_2 = registerBlock("book_2",
            new TrackEndBlock(FabricBlockSettings.of(Material.WOOL).strength(0.8f, 0.8f).nonOpaque()),DBEItemGroup.DBEGROUP);

    public static final Block SKELETON_1 = registerBlock("skeleton_1",
            new TrackEndBlock(FabricBlockSettings.of(Material.STONE).strength(1.0f, 1.0f).nonOpaque()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block REINFORCED_GLASS = registerBlock("reinforced_glass",
            new Block(FabricBlockSettings.of(Material.GLASS).strength(15f, 1200f).nonOpaque()),DBEItemGroup.DBEGROUP);
    public static final Block ONEWAY_STONE = registerBlock("oneway_stone",
            new FacingBlock(FabricBlockSettings.of(Material.GLASS).strength(1.0f, 1.0f).nonOpaque()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block VANTA_BLACK = registerBlock("vanta_black",
            new Block(FabricBlockSettings.of(Material.STONE).strength(1.5f, 1.0f).nonOpaque()),DBEItemGroup.DBEGROUP);
    ...
    public static final Block RUBBER_DUCK = registerBlock("rubber_duck",
            new RubberDuckBlock(FabricBlockSettings.of(Material.WOOL).strength(0.8f, 1.0f).nonOpaque()),DBEItemGroup.DBEGROUP);
