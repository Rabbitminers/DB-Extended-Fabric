...
public class DBEBlocks {
    ...
    public static final Block TUNGSTEN_BLOCK = registerBlock("tungsten_carbite",
            new Block(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);
    ...
    public static final Block STEEL_STAIRS = registerBlock("steel_stairs",
            new DBEStairs(DBEBlocks.CUT_STEEL.getDefaultState(), FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);

    public static final Block STEEL_SLAB = registerBlock("steel_slab",
            new SlabBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);
    public static final Block STEEL_FRAME = registerBlock("steel_frame",
            new Block(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).nonOpaque().requiresTool()), ItemGroup.MISC);

    public static final Block STEEL_WALL = registerBlock("steel_wall",
            new WallBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);
    ...
    public static final Block STEEL_DOOR = registerBlock("steel_door",
            new DoorBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);

    public static final Block STEEL_TRAPDOOR = registerBlock("steel_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool()), ItemGroup.MISC);

    public static final Block STEEL_MESH_TRAPDOOR = registerBlock("steel_mesh_trapdoor",
            new TrapdoorBlock(FabricBlockSettings.of(Material.METAL).strength(1.0f, 6f).requiresTool().nonOpaque()), ItemGroup.MISC);
    ...
    public static final Block VANTA_BLACK = registerBlock("vanta_black",
            new Block(FabricBlockSettings.of(Material.STONE).strength(6f, 1.0f).nonOpaque()), ItemGroup.MISC);
    ...
    public static final Block RUBBER_DUCK = registerBlock("rubber_duck",
            new RubberDuckBlock(FabricBlockSettings.of(Material.WOOL).strength(2f, 1.0f).nonOpaque()), ItemGroup.MISC);
